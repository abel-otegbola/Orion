...
function Footer() {
    ...
    return (
        <footer className={`bg-gray-500/[0.06] border border-gray-500/[0.1] dark:bg-[#101012] dark:text-white md:mt-[100px] mt-8 md:my-4 md:mx-[8%] md:rounded-[20px] ${pathname.indexOf("/dashboard") !== -1 ? "hidden" : ""}`}>
            <div className="grid md:grid-cols-4 grid-cols-2 max-[300px]:grid-cols-1 items-start md:gap-[30px] gap-[60px] md:px-[8%] p-8 py-[60px]">
                ...
                <div className="flex flex-col md:items-end gap-4 col-span-2">
                    <h1 className="text-[20px] text-primary font-bold">Flash notes</h1>
                    <ul className="">
