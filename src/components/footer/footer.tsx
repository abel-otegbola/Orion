...
function Footer() {
    ...
    return (
        <footer className={`bg-[#110E13] border border-gray-500/[0.1] text-white md:mt-[100px] ${pathname.indexOf("/dashboard") !== -1 ? "hidden" : ""}`}>
            <div className="grid md:grid-cols-3 items-center md:gap-[30px] gap-[30px] md:px-[8%] p-8 py-[60px]">
                ...
                <Link href="/" className="flex md:justify-center text-[20px]">
                    Orion
                </Link>
            ...
            <div className="border-t border-gray-500/[0.2] text-center">
                <p className="px-[3%] py-10 flex items-center font-bold gap-2 justify-center">Orion &copy; Copyright  {new Date().getFullYear()}</p>
            </div>
        </footer>
    )
}
