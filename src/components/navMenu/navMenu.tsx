...
export default function Menu ({ close, list }: MenuProps) {
    ...
    return (
        <div className="flex flex-col gap-1 py-2 w-[160px] rounded shadow-md border border-gray-500/[0.3] dark:border-gray-500/[0.06] absolute top-12 right-0 bg-white dark:bg-black dark:text-gray z-[10]">
            { 
                list.map(item => (
                    <Link
                        key={item.id}
