    ...
    <div className="p-4 flex md:flex-nowrap flex-wrap gap-4">
      <div className="flex flex-col gap-4 h-full md:w-[70%]">
        <div className="flex items-center justify-between">
          ...
          <div className="flex">
          <Button onClick={() => setOpen(!open)}>Create new Task</Button>
            <button 
              className={`${layout === "Calendar" ? "bg-primary text-white" : ""} p-2 text-[16px] rounded-l border border-gray-500/[0.2] ml-4`}
              onClick={() => setLayout("Calendar")}
            >
                <Calendar />
            </button>
            <button 
              className={`${layout === "Grid" ? "bg-primary text-white" : ""} p-2 text-[16px] border border-gray-500/[0.2]`}
              onClick={() => setLayout("Grid")}
            >
                <GridFour />
            </button>
            <button 
              className={`${layout === "List" ? "bg-primary text-white" : ""} p-2 text-[16px] rounded-r border border-gray-500/[0.2]`}
        ...
        <div className="border border-gray-500/[0.1] bg-black/[0.5] min-h-[600px] rounded-lg flex-1 max-h-screen overflow-y-auto">
            <TasksLayout tasks={[
